...
```
<img width="800" height="600" alt="githubexample_genomicregions" src="https://github.com/user-attachments/assets/fd1854b8-5856-433d-ab47-8c1002879210" />
...
dotplot(hyper_ego, x="FoldEnrichment") +
  ...
  theme_cowplot(16)
```
<img width="800" height="600" alt="GO_no_methylation" src="https://github.com/user-attachments/assets/b8ff7677-7e77-488a-81bf-4e598e9aa57e" />
...
ggplot(m6A_subset, aes(x = mean_CPM, y = tail_length)) +
  ...
  ```
<img width="800" height="600" alt="githubexample_CPMSTOICH_AND_POLYA" src="https://github.com/user-attachments/assets/db10c5fd-0015-4d89-a92a-318c0db87ab9" />
